...
add_O0.out:     file format elf64-x86-64
...
0000000000001060 <_start>:
    ...
    1078:	48 8d 3d e8 00 00 00 	lea    0xe8(%rip),%rdi        # 1167 <main>
...
0000000000001167 <main>:
    ...
    1173:	c7 45 f4 04 00 00 00 	movl   $0x4,-0xc(%rbp)
    117a:	c7 45 f8 08 00 00 00 	movl   $0x8,-0x8(%rbp)
    1181:	8b 55 f8             	mov    -0x8(%rbp),%edx
    1184:	8b 45 f4             	mov    -0xc(%rbp),%eax
    1187:	89 d6                	mov    %edx,%esi
    1189:	89 c7                	mov    %eax,%edi
    118b:	e8 b9 ff ff ff       	call   1149 <plus>
