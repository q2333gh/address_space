...
0000000000001090 <random@plt>:
    1090:	f3 0f 1e fa          	endbr64 
    1094:	f2 ff 25 35 2f 00 00 	bnd jmp *0x2f35(%rip)        # 3fd0 <random@GLIBC_2.2.5>
...
0000000000001189 <main>:
    ...
    11a7:	e8 c4 fe ff ff       	call   1070 <puts@plt>
    11ac:	48 8d 05 d6 ff ff ff 	lea    -0x2a(%rip),%rax        # 1189 <main>
    11b3:	48 89 c6             	mov    %rax,%rsi
    11b6:	48 8d 05 53 0e 00 00 	lea    0xe53(%rip),%rax        # 2010 <_IO_stdin_used+0x10>
    11bd:	48 89 c7             	mov    %rax,%rdi
    11c0:	b8 00 00 00 00       	mov    $0x0,%eax
    11c5:	e8 b6 fe ff ff       	call   1080 <printf@plt>
    11ca:	b8 00 00 00 00       	mov    $0x0,%eax
    11cf:	e8 bc fe ff ff       	call   1090 <random@plt>
    11d4:	89 45 f4             	mov    %eax,-0xc(%rbp)
    11d7:	8b 45 f4             	mov    -0xc(%rbp),%eax
    11da:	89 c6                	mov    %eax,%esi
    11dc:	48 8d 05 30 0e 00 00 	lea    0xe30(%rip),%rax        # 2013 <_IO_stdin_used+0x13>
